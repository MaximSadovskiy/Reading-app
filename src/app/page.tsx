...
export default function RootPage() {
	...
	const textBeforeLinkToLC = 'Если вы посещаете нас впервые, то мы рекомендуем Вам зарегистрироваться, это позволит добавлять понравившиеся книги в раздел Желаемое: ';
